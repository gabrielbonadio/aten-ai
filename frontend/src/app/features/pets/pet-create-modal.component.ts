...
import { Component, HostListener, OnInit, effect, inject, input, output, signal, computed } from '@angular/core';
import { FormBuilder, ReactiveFormsModule, Validators } from '@angular/forms';
import { LucideAngularModule } from 'lucide-angular';
import type { CreatePetPayload } from '../../core/models/pet.model';
  ...
  submit(): void {
    ...
    this.petService.create(payload).subscribe({
      next: () => {
        ...
        this.notifications.success('Pet cadastrado com sucesso.');
        this.created.emit();
        this.dismissed.emit();
      },
      error: (err: unknown) => {
